...
def test_advanced_review_error_codes_are_stable() -> None:
    required = {
        ...
        "artifact_file_content_unavailable",
        "artifact_content_range_invalid",
        "artifact_page_invalid",
        "artifact_diff_not_found",
        "artifact_diff_hunk_invalid",
        "artifact_diff_hunk_not_found",
        "artifact_diff_hunk_unavailable",
        "artifact_diff_too_large",
        ...
        "superseded_artifact_invalid",
        "superseded_artifact_forbidden",
        "resubmission_content_unchanged",
